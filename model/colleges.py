...
def initColleges():
    with app.app_context():
        ...
        c13 = College(name='University of Pennsylvania', link='https://admissions.upenn.edu/admissions-and-financial-aid', image='https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/University_of_Pennsylvania_seal.svg/1200px-University_of_Pennsylvania_seal.svg.png', tuition=85738, studentCount=22432, studentFaculty=6, safetyScore=1.2, graduationrate=0.95)
        c14 = College(name='California Institute of Technology (Caltech)', link='https://www.admissions.caltech.edu/apply', image='https://upload.wikimedia.org/wikipedia/en/thumb/8/80/Caltech_seal.svg/1200px-Caltech_seal.svg.png', tuition=79947, studentCount=2240, studentFaculty=3, safetyScore=0.7, graduationrate=0.94)
